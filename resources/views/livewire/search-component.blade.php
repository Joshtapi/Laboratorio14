...
<main id="main" class="main-site left-sidebar">
    <p>search componenets</p>
    <div class="container">

        <div class="row">
            {{-- Primera Columna --}}
            <div class="col-3">
                <div class="bg-warning w-full h-full">
                    a
                </div>
                <div class="">
                                    ...
                                    <div class="product product-widget-style">
                                        <div class="thumbnnail">
                                            <a href="detail.html"
                                                ...
                                                <figure><img
                                                        src="{{ asset('assets/images/products/digital_1.jpg') }}"
                                                        alt=""></figure>
                                            </a>
                                        </div>
            ...
            <div class="col-9">
                ...
                <div class="">{{-- col-lg-9 col-md-8 col-sm-8 col-xs-12 --}}
                    ...
                    <div class="wrap-shop-control">
                        @if ($category)
                            <h1 class="shop-title ">Categoria : {{ $category->name }}</h1>
                        @else
                            <h1 class="shop-title">Productos Relacionados con la busqueda : {{ $product }}</h1>
                        @endif
                        ...
                        <div class="wrap-right">
                            ...
                            <div class="sort-item product-per-page">
                                <select name="post-per-page" class="use-chosen" wire:model="pagesize">
                                    <option value="1" selected="selected">12 per page</option>
                                        ...
                                        <div class="product product-style-3 equal-elem ">
                                                ...
                                                @if ($product->image)
                                                    <a href="{{ route('product.details', ['slug' => $product->slug]) }}"
                                                        ...
                                                        <figure><img class="img-fluid"
                                                                src="{{ Storage::url($product->image) }}"></figure>
                                                    </a>
                                                @else
                                                    <a href="">
                                                        <figure><img class="img-fluid"
                                            ...
                                            <div class="product-info">
                                                ...
                                                <div class="wrap-price"><span
                                                        class="product-price">${{ $product->price_cost }}</span>
                                                </div>
                                    

                                                <a class="btn add-to-cart"
                                                    wire:click="store('{{ $product->id }}')">Add
                                                    To Cart</a>
                                            </div>
                                        </div>
                                    </li>

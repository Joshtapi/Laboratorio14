    ...
    <div class=" my-4 p-5 bg-gray-100 rounded rounded-2xl drop-shadow-2xl border-2 border-gray-200">
        ...
        <div class="grid grid-cols-6">
            ...
            <div class="col-span-6 md:col-span-3 inline-block my-2 px-5">
                ...
                <textarea wire:model="sliderCreate.subtitle" rows="3"
            ...
            <div class="col-span-6 md:col-span-3 lg:col-span-2 inline-block my-2 px-5">
                ...
                <span class="mr-2">Con Stock</span><input checked wire:model="sliderCreate.status" class="mr-8"
                    name="status" type="radio" value="1">{{-- con stock --}}
                <span class="mr-2">Sin Stock</span><input wire:model="sliderCreate.status" class=""

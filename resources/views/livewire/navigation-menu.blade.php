<header {{-- class="bg-green-400 sticky top-0 " style="z-index: 900" --}}>
    ...
    <div class="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8  p-1">
        ...
        <div class="bg-black flex font-semibold text-md capitalize text-white mt-1">
            <div class="py-2 px-4 hover:bg-red-500 hover:text-black"><a href="#"><i
                        class="fa-solid fa-house"></i></a></div>
            <div class="py-2 px-4 hover:bg-red-500 hover:text-black"><a href="#">Productos</a></div>
            <div class="py-2 px-4 hover:bg-red-500 hover:text-black"><a href="#">Carrito</a></div>
            <div class="py-2 px-4 hover:bg-red-500 hover:text-black"><a href="#">checkout</a></div>
